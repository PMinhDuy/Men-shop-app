    ...
    <div className="flex flex-col space-y-2">
      <div className="relative cursor-pointer">
        ...
        <div className="absolute left-0 bottom-1 w-full flex items-end h-full opacity-0 hover:opacity-100 hover:transition-all hover:duration-300">
          <div className="bg-slate-700 hover:bg-[#fe9614] hover:duration-100 hover:transition-all rounded-b-xl w-full space-x-2 h-1/5 flex justify-center items-center">
